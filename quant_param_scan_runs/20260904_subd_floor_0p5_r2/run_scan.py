...
def main() -> None:
    ...
    accepted = pd.read_csv(RUN_DIR.parent / "20260904_mixed_us_cn_momentum_subd_pure_momentum_core_six_etf_mixed_pool_score_min_absolute_momentum_floor/daily_outputs/score_min_0p5.csv.gz", parse_dates=["date"]).set_index("date")
    compare("off_vs_accepted_floor_0p5", accepted, curves[None])
    ...
    meta["parity_check"] = {
        "checks": ["accepted_floor_0p5", "zero_vs_off", "cached_vs_uncached_0.20", "runner_vs_poe_0.20"],
